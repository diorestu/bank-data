...
@section('content')
    <form class="card" id="addLeadForm" method="POST" action="{{ route('kandidat.store') }}" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="card-body">
            ...
            <div class="mb-3 row">
                <label class="col-sm-3 col-form-label required">NIK<span><sup class="text-danger">*</sup></span></label>
                <div class="col">
                    <input type="text" class="form-control @error('nik') is-invalid @enderror" placeholder="16 digit"
                        name="nik" value="{{ old('nik') }}" id="nik" required>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col">
                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                        placeholder="Nama lengkap kandidat sesuai dengan KTP" name="nama" value="{{ old('nama') }}"
                        id="nama" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-sm-3 col-form-label required">Agama<span><sup class="text-danger">*</sup></span></label>
                <div class="col">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                <label class="col-sm-3 col-form-label required">Jenis Kelamin<span><sup
                            class="text-danger">*</sup></span></label>
                <div class="col">
                    <select class="" id="gender" name="gender" id="gender">
        ...
        <div class="card-body">
            <div class="mb-3 row">
                ...
                <div class="col">
                    <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Email Kandidat"
